  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <div ref={imageRef} className="relative h-80 w-full max-w-xs mt-6">
         {/* Arch Image */}
         <div className="absolute top-0 left-18 w-56 h-80 bg-bgSection rounded-t-full z-10 overflow-hidden">
            <img 
         ...
         {/* Circle Image */}
         <div className="absolute bottom-0 -right-12 -bottom-32 w-40 h-40 bg-bgAccent rounded-full z-20 overflow-hidden ">
            <img 
